...
class FormDefinitionFieldInline(admin.StackedInline):
    ...
    fieldsets = [
        ...
        (_('Model Choices'), {'fields': ['choice_model', 'choice_model_empty_label', 'choice_model_queryset']}),
    ]
...
class FormDefinitionAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        (_('Settings'), {'fields': ['allow_get_initial', 'log_data', 'success_redirect', 'redirect_url', 'success_clear', 'display_logged', 'save_uploaded_files'], 'classes': ['collapse']}),
